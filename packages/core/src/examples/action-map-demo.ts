...
function executeCommandPrompt(renderer: CliRenderer): void {
  ...
  const result = actionMap?.runCommand(parsed.raw, { focused: focused ?? null, includeCommand: true })
...
function buildWhichKeyEntries(): StyledText {
  ...
  const activeKeys = [...actionMap.getActiveKeys({ includeMetadata: true })].sort((left, right) => {
    ...
    statusInfoText.content = focusedEditor
      ? joinLines([
          styledLine([
            ...
            fg(P.separator)("  |  "),
            fg(P.textDim)("Keys: "),
            fg(P.command)(focusedEditor.traits.suspend === true ? "action-map" : "local"),
          ]),
        ])
      : joinLines([
          styledLine([
...
export function run(renderer: CliRenderer): void {
  ...
  const title = new TextRenderable(renderer, {
    id: "action-map-demo-title",
    content: "Action Map Demo",
    fg: P.title,
  ...
  const detailsColumn = new BoxRenderable(renderer, {
    id: "action-map-demo-details-column",
    flexGrow: 1,
    minWidth: 0,
    flexDirection: "column",
  })
  ...
  statusFocusedText = new TextRenderable(renderer, {
    id: "action-map-demo-status-focused",
    content: "",
    fg: P.text,
    height: 1,
  })
  ...
  statusInfoText = new TextRenderable(renderer, {
    id: "action-map-demo-status-info",
    content: "",
    fg: P.text,
    height: 1,
  })
  ...
  statusLeaderText = new TextRenderable(renderer, {
    id: "action-map-demo-status-leader",
    content: "",
    fg: P.text,
    height: 1,
  })
  ...
  statusLastText = new TextRenderable(renderer, {
    id: "action-map-demo-status-last",
    content: "",
    fg: P.text,
    height: 1,
  })
  ...
  whichKeyHeaderText = new TextRenderable(renderer, {
    id: "action-map-demo-wk-header-text",
    content: "",
    fg: P.text,
    height: 1,
  })
  ...
  whichKeyEntriesText = new TextRenderable(renderer, {
    id: "action-map-demo-wk-entries-text",
    content: "",
    fg: P.text,
    width: "100%",
    wrapMode: "word",
  ...
  commandPromptHintText = new TextRenderable(renderer, {
    id: "action-map-demo-ex-prompt-hint",
    content: "",
    fg: P.textMuted,
    height: 1,
  })
  ...
  commandPromptSuggestionsText = new TextRenderable(renderer, {
    id: "action-map-demo-ex-prompt-suggestions",
    content: "",
    fg: P.text,
    height: getCommandPromptSuggestionRows(),
  })
