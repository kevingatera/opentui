...
const scenarios = [_]Scenario{
    ...
    .{ .name = "RGB555 level 1 up", .level = 1, .predictor = 2, .color_mode = 7, .bits = .{ 5, 5, 5 } },
    .{ .name = "RGB555 level 1 paeth", .level = 1, .predictor = 4, .color_mode = 7, .bits = .{ 5, 5, 5 } },
    .{ .name = "RGB454 level 1 up", .level = 1, .predictor = 2, .color_mode = 8, .bits = .{ 4, 5, 4 } },
    .{ .name = "RGB454 level 1 paeth", .level = 1, .predictor = 4, .color_mode = 8, .bits = .{ 4, 5, 4 } },
