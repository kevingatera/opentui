...
The build also enables FFmpeg's PNG encoder. Native video frames are quantized to RGB343 (1,024 colors) and encoded by one persistent encoder per video instance for Kitty graphics transport.
