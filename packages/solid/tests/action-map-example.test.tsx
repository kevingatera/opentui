...
import { getActionMap } from "@opentui/core/extras"
import { testRender } from "../index.js"
import ActionMapDemo from "../examples/components/action-map-demo.js"
...
describe("solid action map example", () => {
  beforeEach(async () => {
    if (testSetup) {
  ...
  test("renders the core-aligned action map demo and supports textarea focus cycling", async () => {
