...
This installs Bun runtime support for `@opentui/core` plus default core runtime entrypoints (`@opentui/core/testing`). Add `@opentui/three` explicitly when a plugin needs the 3D package.
