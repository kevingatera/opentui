...
export declare class DiffRenderable extends Renderable {
    ...
    private _highlightAddedBg;
    private _highlightRemovedBg;
    private _addedSignColor;
    private _removedSignColor;
    private _addedLineNumberBg;
    private _removedLineNumberBg;
    private _leftDiffHighlightRanges;
    private _rightDiffHighlightRanges;
    private _leftDiffOnHighlight;
    private _rightDiffOnHighlight;
    private leftSide;
    private rightSide;
    ...
    get highlightAddedBg(): RGBA | null;
    set highlightAddedBg(value: string | RGBA | null);
    get highlightRemovedBg(): RGBA | null;
    set highlightRemovedBg(value: string | RGBA | null);
